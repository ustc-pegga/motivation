...
def generate_data_test4(op,datasets):
    # generate some dw op
    ...
    csv_path = '../data/test4/{}/test4_{}.csv'.format(datasets,op)
    export_path = '../data/test4/{}/test4_{}'.format(datasets,op)
...
def generate_data_test1():
    ...
    for op in ops:
        generate_data_test4(op)


if __name__ == "__main__":
    generate_data_test4("convbn")