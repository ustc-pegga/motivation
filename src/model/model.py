...
class TestNet(nn.Module):
    def __init__(self,in_channels,out_channels,kernel_size,stride,type):
        ...
        if type == 'conv':
            ...
            conv = conv_dw
        for i in range(18):
            self.features.append(conv(in_channels,out_channels,stride,kernel_size))
...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.,kernel_size=3,kernel_list = None):
...
class MobileNet(nn.Module):
    def __init__(self, n_class,cfg=[3, 32, 64, 128, 128, 256, 256, 512, 512, 512, 512, 512, 512, 1024, 1024],kernel_size = 3,kernel_list=None):
        ...
        self.conv1 = conv_bn(tmp[0], tmp[1], stride=2)
