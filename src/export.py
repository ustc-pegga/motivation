...
if __name__ == '__main__':
    ...
    input = get_input(dataset)
    input2 = get_input2(dataset)
    print(export_path)
    onnx_export(net, input2 ,export_path, '{}_{}_{}'.format(model,dataset,args.name))
    flops,params,macs = measure_model(net,(3,input[0],input[1]))
